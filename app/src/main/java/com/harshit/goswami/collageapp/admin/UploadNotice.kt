...
import com.harshit.goswami.collageapp.databinding.ActivityUploadNoticeBinding
...
class UploadNotice : AppCompatActivity() {
    ...
    private fun uploadImgAndData()
    {
        if (fileUri != null) {
            ...
            storageRef = firebaseStorage.reference.child("NoticeImages").child(UUID.randomUUID().toString())
